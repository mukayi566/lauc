      ...
      <div className="container">
        ...
        <div className="about-two-col" style={{ marginTop: 40 }}>
          <div className="about-text">
            ...
            <p>Guided by the motto “We Aim At Excellence,” Fairview University College focuses on developing highly skilled educators and professionals capable of contributing positively to society. The college offers programmes in Teacher Education, Early Childhood Education, Journalism, Public Relations, Social Work, Information and Communication Technology, Hospitality, and other professional disciplines.</p>
            <p>The institution combines academic theory with practical learning experiences to prepare students for the demands of the modern workplace. Through dedicated lecturers, flexible learning options, and a supportive academic environment, Fairview University College continues to empower students with the knowledge, values, and confidence needed for lifelong success.</p>
